...
class NewCrownMolding extends Component {
  ...
  addCrownMolding(event) {
    ...
    if (crownName != '' && supplier != '') {
      Meteor.call('insertNewCrownMolding',crownName,supplier,ftOak,ftMaple,ftPoplar,ftPine);
  ...
  render() {
    return(
      <div>
        <PageHeader>Crown Molding Database</PageHeader>
