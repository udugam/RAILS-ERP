...
import {Modal, Button, Panel, Tabs, Tab, Table} from 'React-Bootstrap';
...
export default class EditRoom extends Component {
  constructor(props) {
    super(props);
    this.state = {
      roomNum: props.room.roomNum,
      description: props.room.description,
      linFootage: props.room.linFootage,
      height: props.room.height,
      constructionMaterial: props.room.constructionMaterial,
      quote: props.room.quote,
      doorSpecies: props.room.doorSpecies,
      doorStyle: props.room.doorStyle,
      color: props.room.color,
      drawerQty: props.room.drawerQty,
      drawerModel: props.room.drawerModel,
      hardware: props.room.hardware,
      hardwareQty: props.room.hardwareQty,
      crownMolding: props.room.crownMolding,
      quoteAccessories: props.room.quoteAccessories,
      pendingAccessoryID:'',
      pendingAccessoryQty:0,
      quoteMillworkItems: props.room.quoteMillworkItems,
    ...
    this.updateThenClose = this.updateThenClose.bind(this);
  }
  ...
  render() {
    return (
      <Modal {...this.props} bsSize="large" aria-labelledby="contained-modal-title-lg">
                  ...
                  <Tab eventKey={1} title="Construction Information">
                    ...
                    <div className='form-group'>
                      ...
                      <div className='col-sm-4'>
                        <input placeholder={this.state.description} type='text' className='form-control' name='description' ref='description' onChange={this.handleInputChange}/>
                      </div>
                    </div>
                    ...
                    <div className='form-group'>
                      ...
                      <div className='col-sm-4'>
                        <input placeholder={this.state.linFootage} type='number' className='form-control' name='linFootage' ref='linFootage' onChange={this.handleInputChange}/>
                      </div>
                    </div>
                    ...
                    <div className='form-group'>
                      ...
                      <div className='col-sm-4'>
                        <input placeholder={this.state.height} type='number' className='form-control' name='height' ref='height' onChange={this.handleInputChange}/>
                      </div>
                    </div>
                    ...
                    <div className='form-group'>
                      ...
                      <div className='col-sm-4'>
                        <select className='form-control' name='constructionMaterial' ref='constructionMaterial' onChange={this.handleInputChange}>
                          <option>{this.state.constructionMaterial}</option>
                          {this.props.materials.map((storedMaterial) => {
                            if (storedMaterial.name != this.state.constructionMaterial) {
                              return (
                    ...
                    <div className='form-group'>
                      ...
                      <div className='col-sm-4'>
                        <select className='form-control' name='doorSpecies' ref='doorSpecies' onChange={this.handleInputChange}>
                          <option>{this.state.doorSpecies}</option>
                    ...
                    <div className='form-group'>
                      ...
                      <div className='col-sm-4'>
                        <select className='form-control' name='doorStyle' ref='doorStyle' onChange={this.handleInputChange}>
                          <option>{this.state.doorStyle}</option>
                          {this.props.doorStyles.map((storedDoorStyle) => {
                            if(storedDoorStyle.name != this.state.doorStyle) {
                              return (
                    ...
                    <div className='form-group'>
                      ...
                      <div className='col-sm-4'>
                        <select className='form-control' name='color' ref='color' onChange={this.handleInputChange}>
                          <option>{this.state.color}</option>
                          {this.props.colors.map((storedColor) => {
                            if (storedColor.name != this.state.color) {
                              if (this.state.doorSpecies === 'MDF') {
                                if (storedColor.finishType === 'Paint') {
                                  return (
                    ...
                    <div className='form-group'>
                      <div className='row'>
                        <div className='col-sm-6'>
                          ...
                          <div className='col-sm-4'>
                            <select className='form-control' name='drawerModel' ref='drawerModel' onChange={this.handleInputChange}>
                              <option>{this.state.drawerModel}</option>
                              {this.props.drawers.map((storedDrawer) => {
                                if (storedDrawer.model != this.state.drawerModel) {
                                  return (
                        ...
                        <div className='col-sm-6'>
                          ...
                          <div className='col-sm-4'>
                            <input type='number' placeholder={this.state.drawerQty} className='form-control' name='drawerQty' ref='drawerQty' onChange={this.handleInputChange}/>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='form-group'>
                      <div className='row'>
                        <div className='col-sm-6'>
                          ...
                          <div className='col-sm-4'>
                            <select className='form-control' name='hardware' ref='hardware' onChange={this.handleInputChange}>
                              <option>{this.state.hardware}</option>
                              {this.props.hardware.map((storedHardware) => {
                                if(storedHardware.name != this.state.hardware) {
                                  return (
                        ...
                        <div className='col-sm-6'>
                          <label className='col-sm-2 control-label'>Quantity</label>
                          <div className='col-sm-4'>
                            <input type='text' className='form-control' placeholder={this.state.hardwareQty} ref='hardwareQty' onChange={this.handleInputChange}/>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='form-group'>
                      ...
                      <div className='col-sm-4'>
                        <select className='form-control' name='crownMolding' ref='crownMolding' onChange={this.handleInputChange}>
                          <option>{this.state.crownMolding}</option>
                          {this.props.crownMoldings.map((storedCrownMolding) => {
                            if(storedCrownMolding.name != this.state.crownMolding) {
                              return (
        ...
        <Modal.Footer>
          <Button onClick={this.updateThenClose}>Update & Close</Button>
        </Modal.Footer>
      </Modal>
    );
  }
